...
export default function OrphanStatus() {
  ...
  let cloudResourceTypes = findOcc(cloudData.filteredOrphanData, "ResourceStatus");
  const labels = cloudResourceTypes.map(
    (currelem: any) => currelem.ResourceStatus
  );
  ...
  return (
    <div className="d-flex flex-column w-100">
      <small className=" fw-bold mb-0 nav-font">Orphan Object Status</small>
