...
import ModularizationForm from "../Chatbot_Genai/ModularizationForm";
import ChatInput from "../Chatbot_Genai/ChatInput";
import Typewriter from "../Chatbot_Genai/Typewriter";
import ResourceDetailsList from "../Chatbot_Genai/ResourceDetailsList";
import { Vulnerability } from "../Chatbot_Genai/Vulnerability";
                            ...
                            <div className="flex-grow-1 ">
                              {/* {userInput && (
                                <div className="d-flex flex-column w-50 justify-content-end">
                                  <div className="user-input bg-light p-2 rounded-pill mb-3 role_fnt">
                                    <p className="text-start">{userInput}</p>
                                  </div>
                                  {imageURL && <img
                                    src={imageURL}
                                    alt="Preview"
