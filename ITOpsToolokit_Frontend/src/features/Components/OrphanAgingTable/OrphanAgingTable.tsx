...
const OrphanAgingTable: React.FC = () => {
  ...
  initialData = cloudData.filteredOrphanData.filter((item: any) => {
      ...
      <div className="row col-row-2 mt-2">
        <div className="col-12 gx-2">
          <Tile>
            ...
            (pathname.includes("orphanaging") &&
              cloudData.filteredOrphanData.length > 0) ? (
              <Tableedit apiUrl={apiUrl} customData={filterData} />
            ) : (
              navigate({
...
export default OrphanAgingTable;
