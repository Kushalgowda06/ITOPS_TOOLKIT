...
const AWSMigrationForm = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const { az_ppt_path, txt_content } = response.data.data;
      setApiResponse(txt_content);
  ...
  const handleExcelUpload = async () => {
    ...
    try {
      ...
      setApiResponse(null);
      const response = await axios.post(
        "http://ec2-16-52-107-209.ca-central-1.compute.amazonaws.com:8006/aws_migration_assessment/upload-excel/",
      ...
      const { excelStoragePath, data } = response.data;
      console.log("downloadFile",excelStoragePath,data)
      // setApiResponse(excelStoragePath);
      downloadFile(data);
...
export default AWSMigrationForm;
