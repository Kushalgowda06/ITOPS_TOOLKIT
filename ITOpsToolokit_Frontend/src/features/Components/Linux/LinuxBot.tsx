...
const LinuxBot = ({ show, onHide, title, sysData }) => {
                                ...
                                <div className="container popup_content-width ps-md-5  role_cls">
                                    <div className="row text-muted ps-md-5 tab">
                                        ...
                                        <div className="col-md-6 pt-2">
                                            ...
                                            >
                                                <span className=" text-color fw-bold cursor-pointer ps-1">
                                                    {selectedTicket?.short_description?.substring(0, 29)}
                                                    {selectedTicket?.short_description?.length > 10 ? "..." : ""}
                                                </span>
                                            </Tooltip>
                                        </div>
                                        <div className="col-md-6 pt-2">
                                            ...
                                            >
                                                <span className=" text-color fw-bold cursor-pointer ps-1">
                                                    ...
                                                    {selectedTicket?.description?.length > 15 ? "..." : ""}
                                                </span>
                                            </Tooltip>
                                        </div>
                                    </div>
