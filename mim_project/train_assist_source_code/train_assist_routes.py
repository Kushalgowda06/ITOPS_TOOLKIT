...
@router.post(f"/api/v1/get_pending_quizes/", status_code=200)
async def get_pending_quizes(payload:GetPendingQuizesPayload):
    response = {}
    ta_obj = TrainAssist()

    try:
        data = ta_obj.get_pending_quizes(user_id = payload.user_id)
...
@router.post(f"/api/v1/get_completed_quizes/", status_code=200)
async def get_completed_quizes(payload:GetPendingQuizesPayload):
    response = {}
    ta_obj = TrainAssist()

    try:
        data = ta_obj.get_completed_quizes(user_id = payload.user_id)
...
@router.post(f"/api/v1/get_all_quizes/", status_code=200)
async def get_all_quizes(payload:GetPendingQuizesPayload):
    response = {}
    ta_obj = TrainAssist()

    try:
        data = ta_obj.get_all_quizes(user = payload.user_id)
...
@router.get(f"/api/v1/get_all_quizes/", status_code=200)
async def get_all_quizes():
    response = {}
    ta_obj = TrainAssist()

    try:
        data = ta_obj.get_all_quizes()
